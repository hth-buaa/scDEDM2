...
#' A positive numeric object. Defines the promoter region around TSS (in base pairs). Default is 50 bp.
...
#' In practice, the term "promoter" here is used in a broad sense as a collective term for both promoters and enhancers, i.e., cis-regulatory elements that promote regulation.
...
#' # Load scRNA-seq data and scATAC-seq data
#' # as object scRNAseq and scATACseq with the same cells and cell labels.
...
#'   file = "./1.1 Data Preprocessing - Identify TGs By Annotation/results_identify_TGs.rds"
#' )
#' }
