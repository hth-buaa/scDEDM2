...
#' @examples
#' \dontrun{
#' # The settings for parameters are inside these three functions:
#' # scDEDM::f_train_cal_gr,
#' # scDEDM::gradient_ascent_train,
#' # or scDEDM::gradient_ascent_train model_train.
#' f0 = f_train_cal(
#'   params,
                        ...
                        Tslot_K = Tslot_K)
{
  ...
  R = base::as.numeric(scDEDM::R_cal(
